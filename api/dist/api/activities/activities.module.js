...
exports.ActivityModule = ActivityModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: "Activity", schema: activities_schema_1.ActivitySchema }]),
        ],
        exports: [activities_service_1.ActivityService],
        controllers: [activities_controller_1.ActivityController],
