...
function createShorthand(Component32, mapValueToProps, val, options) {
  if (options === void 0) {
    options = {};
  }
  if (typeof Component32 !== "function" && typeof Component32 !== "string") {
  ...
  if (typeof props.children === "function") {
    return props.children(Component32, _extends({}, props, {
      children: void 0
    }));
  }
  if (valIsPrimitiveValue || valIsPropsObject) {
    return React2.createElement(Component32, props);
  }
  if (valIsFunction) {
    if (true) {
      if (!DEPRECATED_CALLS[Component32]) {
        DEPRECATED_CALLS[Component32] = true;
        console.warn('Warning: There is a deprecated shorthand function usage for "' + Component32 + '". It is deprecated and will be removed in v3 release. Please follow our upgrade guide: https://github.com/Semantic-Org/Semantic-UI-React/pull/4029');
      }
    }
    return val(Component32, props, props.children);
  }
}
function createShorthandFactory(Component32, mapValueToProps) {
  if (typeof Component32 !== "function" && typeof Component32 !== "string") {
    throw new Error("createShorthandFactory() Component must be a string or function.");
  }
  return function(val, options) {
    return createShorthand(Component32, mapValueToProps, val, options);
  };
}
...
var getUnhandledProps = function getUnhandledProps2(Component32, props) {
  var _Component$handledPro = Component32.handledProps, handledProps = _Component$handledPro === void 0 ? [] : _Component$handledPro;
...
function getElementType(Component32, props, getDefault) {
  var _Component$defaultPro = Component32.defaultProps, defaultProps = _Component$defaultPro === void 0 ? {} : _Component$defaultPro;
...
var ManagerReferenceNodeContext = React115.createContext();
var ManagerReferenceNodeSetterContext = React115.createContext();
...
var useIsomorphicLayoutEffect2 = typeof window !== "undefined" && window.document && window.document.createElement ? React116.useLayoutEffect : React116.useEffect;
...
var usePopper = function usePopper2(referenceElement, popperElement, options) {
  ...
  var prevOptions = React117.useRef(null);
  ...
  var updateStateModifier = React117.useMemo(function() {
    return {
      name: "updateState",
      enabled: true,
      phase: "write",
  ...
  var popperOptions = React117.useMemo(function() {
    var newOptions = {
  ...
  var popperInstanceRef = React117.useRef();
...
function Popper(_ref) {
  ...
  var referenceNode = React118.useContext(ManagerReferenceNodeContext);
  var _React$useState = React118.useState(null), popperElement = _React$useState[0], setPopperElement = _React$useState[1];
  var _React$useState2 = React118.useState(null), arrowElement = _React$useState2[0], setArrowElement = _React$useState2[1];
  React118.useEffect(function() {
    setRef(innerRef, popperElement);
  }, [innerRef, popperElement]);
  var options = React118.useMemo(function() {
    return {
      placement,
      strategy,
      onFirstUpdate,
  ...
  var childrenProps = React118.useMemo(function() {
    return {
...
var useEventListener = function useEventListener2(options) {
  ...
  var latestListener = React131.useRef(listener);
  latestListener.current = listener;
  var eventHandler = React131.useCallback(function(event) {
    return latestListener.current(event);
  }, []);
  var timeoutId = React131.useRef(void 0);
  if (true) {
